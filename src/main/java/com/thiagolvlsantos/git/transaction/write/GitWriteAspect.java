...
import com.thiagolvlsantos.git.transaction.scope.AspectScope;
import com.thiagolvlsantos.git.transaction.watcher.EWatcherAction;
import com.thiagolvlsantos.git.transaction.watcher.FileWatcherEvent;
...
public class GitWriteAspect {
	...
	@Around("@annotation(com.thiagolvlsantos.git.transaction.write.GitWrite)")
